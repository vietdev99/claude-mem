...
import { optionalAuthMiddleware, getCurrentUserId } from '../../../server/AuthMiddleware.js';
...
export class SessionRoutes extends BaseRouteHandler {
  ...
  setupRoutes(app: express.Application): void {
    // Legacy session endpoints (use sessionDbId) - localhost only, no auth
    ...
    // New session endpoints (use contentSessionId) - support optional auth for user tracking
    app.post('/api/sessions/init', optionalAuthMiddleware, this.handleSessionInitByClaudeId.bind(this));
    app.post('/api/sessions/observations', optionalAuthMiddleware, this.handleObservationsByClaudeId.bind(this));
    app.post('/api/sessions/summarize', optionalAuthMiddleware, this.handleSummarizeByClaudeId.bind(this));
  }
